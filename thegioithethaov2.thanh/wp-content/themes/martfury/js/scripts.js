(function ($) {
    ...
    martfury.mobileMenu = function () {
        ...
        $('#mf-off-canvas-layer').on('click', function (e) {
            e.preventDefault();
            martfury.$body.removeClass('display-mobile-menu mb-filter-active');
        });
    ...
    martfury.productSearchLabel = function () {
        ...
        martfury.$header.find('.products-search').submit(function () {
            if ($(this).find('#product_cat').val() == '0') {
                $(this).find('#product_cat').removeAttr('name');
            }
        });
    };
        ...
        $images.on('click', '.woocommerce-product-gallery__image', function (e) {
            ...
            $links.each(function () {
                ...
                if ($el.hasClass('mf-product-video')) {
                    ...
                    console.log($el.find('.mf-video-content').html());
    ...
    martfury.stickyProductInfo = function () {
        ...
        $sticky_header.find('.sc-tabs').on('click', 'a', function (e) {
            ...
            if (martfury.$body.hasClass('single-product-layout-3')) {
                ...
                if ($wc_tabs.length > 0) {
                    $wc_tabs.find('.' + target + '_tab a').click();
    ...
    martfury.filterOnMobile = function () {
        ...
        if (!martfury.$body.hasClass('catalog-filter-mobile')) {
            return;
        }

        martfury.$body.on('click', '#mf-filter-mobile', function (e) {
            e.preventDefault();
            martfury.$body.toggleClass('mb-filter-active');

        });

        martfury.$window.on('resize', function () {
            if (martfury.$window.width() > 991) {
                martfury.$body.removeClass('mb-filter-active');
            }
        });
    ...
    martfury.productsLoadInfinite = function () {
        ...
        martfury.$window.on('scroll', function () {
            if (martfury.$body.find('#martfury-products-loading').is(':in-viewport')) {
                martfury.$body.find('#martfury-products-loading').closest('.next').click();
            }
        }).trigger('scroll');
