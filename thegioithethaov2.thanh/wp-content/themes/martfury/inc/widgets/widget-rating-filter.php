 ...
 * @extends  WC_Widget
 */
class Martfury_Widget_Rating_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a list of star ratings to filter products in your store.', 'martfury' );
		$this->widget_id          = 'martfury_rating_filter';
		$this->widget_name        = esc_html__( 'Martfury - Filter Products by Rating', 'martfury' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Average rating', 'martfury' ),
