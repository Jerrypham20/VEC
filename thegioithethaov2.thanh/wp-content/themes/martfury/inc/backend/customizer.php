...
function martfury_customize_settings() {
	...
	$sections = array(
		...
		'header_search_content'       => array(
			'title'       => esc_html__( 'Header Search Content', 'martfury' ),
			'description' => '',
			'priority'    => 20,
			'capability'  => 'edit_theme_options',
			'panel'       => 'header',
		...
		'header_mobile'               => array(
			'title'       => esc_html__( 'Header On Mobile', 'martfury' ),
			'description' => '',
			'priority'    => 20,
			'capability'  => 'edit_theme_options',
			'panel'       => 'header',
	...
	$fields = array(
		...
		'newsletter_home_popup'                   => array(
			...
			'section'     => 'newsletter',
			'priority'    => 10,
			'description' => esc_html__( 'Check this option to disable newsletter popup in the homepage..', 'martfury' ),
		),
		...
		'header_text_color'                       => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '#site-header:not(.minimized) .extras-menu > li > a, #site-header:not(.minimized) .product-extra-search .hot-words li a',
					'property' => 'color',
				),
				array(
					'element'  => '#site-header .recently-viewed .recently-title, #site-header:not(.minimized) .products-cats-menu .cats-menu-title .text, #site-header:not(.minimized) .products-cats-menu .cats-menu-title',
					'property' => 'color',
				),
			),
			'active_callback' => array(
		...
		'search_button_bg_color'                  => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '#site-header:not(.minimized) .product-extra-search .search-submit, #site-header:not(.minimized) .extras-menu > li > a .mini-item-counter',
					'property' => 'background-color',
				),
			),
			'active_callback' => array(
		...
		'menu_bar_hover_color'                    => array(
			...
			'js_vars'         => array(
				array(
					'element'  => '#site-header .header-bar a:hover,.site-header .topbar a:hover,#site-header .primary-nav > ul > li:hover > a',
					'property' => 'color',
				),
			),
			'active_callback' => array(
		...
		'catalog_filter_mobile_els_10'            => array(
			'type'        => 'toggle',
		...
		$fields = array_merge(
			$fields, array(
				'catalog_vendor_name'    => array(
					...
					'priority' => 90,
					'choices'  => array(
						'hover'   => esc_html__( 'After on hover', 'martfury' ),
