 ...
 */
function martfury_content_limit( $content, $num_words, $more = "&hellip;", $echo = true ) {
...
if ( ! function_exists( 'martfury_get_catalog_layout' ) ) :
	function martfury_get_catalog_layout() {
		$layout = '10';
...
if ( ! function_exists( 'martfury_get_catalog_full_width' ) ) :
	function martfury_get_catalog_full_width() {
		...
		if ( $catalog_layout == '1' && intval( martfury_get_option( 'catalog_full_width_1' ) ) ) {
			...
			return true;
		} elseif ( $catalog_layout == '10' && intval( martfury_get_option( 'catalog_full_width_10' ) ) ) {
			return true;
	...
	function martfury_product_video() {
		...
		if ( $video_image ) {
			...
			if ( $video_html ) {
				...
				$video_html    = '<div data-thumb="' . esc_url( $video_thumb[0] ) . '" class="woocommerce-product-gallery__image mf-product-video">' . $video_wrapper . '</div>';
			}
		}
