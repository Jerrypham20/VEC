                ...
                <form class="products-search" method="get" action="%s">
                    <div class="psearch-content">
                        <div class="search-wrapper">
                            <input type="text" name="s"  class="search-field" autocomplete="off" placeholder="Nhập tên sản phẩm bạn muốn tìm">
                        </div>
...
if ( ! function_exists( 'martfury_get_nav_menu' ) ) :
	function martfury_get_nav_menu( $location, $walker = true, $id = '' ) {
		...
		$query_slug = $location . $lang . intval( $walker ) . $id;
