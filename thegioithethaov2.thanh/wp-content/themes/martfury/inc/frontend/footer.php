...
if ( ! function_exists( 'martfury_footer_recently_viewed' ) ) :
	function martfury_footer_recently_viewed() {
		...
		if ( ! intval( martfury_get_option( 'footer_recently_viewed' ) ) ) {
			return;
		}
		...
		$els = martfury_get_option( 'footer_recently_viewed_els' );
		if ( empty( $els ) ) {
			return;
		}
	...
	function martfury_off_canvas_mobile_menu() {
        ...
        <div class="primary-mobile-nav" id="primary-mobile-nav">
            <div class="mobile-nav-content">
				...
				if ( $location ) {
					martfury_get_nav_menu( $location, false );
				}
				?>
