		...
		vc_map(
			array(
				...
				'params'      => array(
					...
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'Deals Type', 'martfury' ),
						'param_name' => 'type',
						'value'      => array(
							esc_html__( 'Day', 'martfury' )   => 'day',
							esc_html__( 'Week', 'martfury' )  => 'week',
							esc_html__( 'Month', 'martfury' ) => 'month',
						),
					),
					array(
						'type'        => 'checkbox',
		...
		vc_map(
			array(
				...
				'params'   => array(
					...
					array(
						'type'       => 'param_group',
						'heading'    => esc_html__( 'Address Infomation', 'martfury' ),
						'value'      => '',
						'param_name' => 'info',
						'params'     => array(
							array(
