			...
			<div id="dup-exportdb-items-off">
				...
				<div id="dup-file-filter-items">
					...
					<div class="dup-tabs-opts-help">
						...
						<?php DUP_PRO_U::esc_html_e("Use full path for directories or specific files. <b>Use filenames without paths to filter same-named files across multiple directories.</b>"); ?> <br/>
			...
			<?php
				...
				switch ($license) {
					case DUP_PRO_License_Type::Personal:
						printf(esc_html($txt_mu_license), DUP_PRO_U::esc_html__("Personal License"));
						echo $txt_mu_basic;
						break;

					case DUP_PRO_License_Type::Freelancer:
						printf(esc_html($txt_mu_license), DUP_PRO_U::esc_html__("Freelancer License"));
						echo $txt_mu_basic;
						break;
