...
//CPANEL
	...
	$_POST['dbpass']	= isset($_POST['cpnl-dbpass']) ? DUPX_U::sanitize_text_field(trim($_POST['cpnl-dbpass'])) : null;
...
$_POST['cpnl-pass']		  = isset($_POST['cpnl-pass']) ? DUPX_U::sanitize_text_field($_POST['cpnl-pass']) : '';
...
$dbTestIn->dbpass	 = DUPX_U::sanitize_text_field($_POST['dbpass']);
...
$dbTestIn->cpnlPass  = DUPX_U::sanitize_text_field($_POST['cpnl-pass']);
...
if ($_POST['view_mode'] == 'cpnl') {
	try {
		...
		$post_cpnl_pass = DUPX_U::sanitize_text_field($_POST['cpnl-pass']);
