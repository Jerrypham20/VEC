...
class DUP_PRO_Global_Entity extends DUP_PRO_JSON_Entity_Base
{
    ...
    public function ResetUserSettings()
    {
        ...
        $this->package_phpdump_mode        = DUP_PRO_PHPDump_Mode::SingleThread;
        ...
        $this->php_max_worker_time_in_sec  = 10;
        ...
        if ($this->php_max_worker_time_in_sec > 10) {
